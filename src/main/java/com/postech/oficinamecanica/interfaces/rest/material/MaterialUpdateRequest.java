...
public record MaterialUpdateRequest(
    ...
    @Schema(description = "Nome do material", example = "Amortecedor Traseiro")
    String name,

    @Schema(description = "Descrição opcional", example = "Peça de reposição")
    String description,

    @NotNull(message = "Price is required")
    @Min(value = 0, message = "Price cannot be negative")
    @Schema(description = "Preço", example = "520.00")
    BigDecimal price,
    ...
    @Schema(description = "Estoque mínimo permitido", example = "3")
