...
@Service
public class StartServiceOrderDiagnosisUseCase {
    private final ServiceOrderRepository repository;
    private final ActiveEmployeeFinder activeEmployeeFinder;

    public StartServiceOrderDiagnosisUseCase(ServiceOrderRepository repository, ActiveEmployeeFinder activeEmployeeFinder) {
    ...
    public ServiceOrder execute(Long serviceOrderId, Long employeeId) {
        ...
        order.startDiagnosis(employeeId);
